...
public class CertificateController {
  ...
  public CollectionModel<ResponseCertificateDto> getCertificates(
      @RequestParam(name = "page", required = false, defaultValue = "1") Integer page,
      @RequestParam(name = "size", required = false, defaultValue = "10") Integer size,
      @RequestParam(required = false) Map<String, String> searchParams) {
    return certificateLinkCreator.getCertificatesWithLinks(
        certificateService.getCertificates(searchParams, page, size));
  }
  ...
  @ResponseStatus(HttpStatus.OK)
  public CollectionModel<ResponseCertificateDto> getCertificatesByTags(
      @RequestParam(name = "page", required = false, defaultValue = "1") Integer page,
      @RequestParam(name = "size", required = false, defaultValue = "10") Integer size,
      @RequestParam(required = false) Map<String, String> tagName) {
    return certificateLinkCreator.getCertificatesWithLinks(
        certificateService.getCertificatesByTags(tagName, page, size));
  }
  ...
  public EntityModel<ResponseCertificateDto> getCertificateById(@PathVariable("id") long id) {
    return certificateLinkCreator.getCertificateWithLinks(
  ...
  public EntityModel<ResponseCertificateDto> addCertificate(
  ...
  @PutMapping(value = "/{id}")
  @ResponseStatus(HttpStatus.OK)
  public EntityModel<ResponseCertificateDto> updateCertificate(
      @PathVariable("id") long id, @RequestBody RequestCertificateDto requestCertificateDto) {
    return certificateLinkCreator.getCertificateWithLinks(
        certificateService.updateCertificate(id, requestCertificateDto));
  }
  ...
  @PatchMapping({"/{id}"})
  @ResponseStatus(HttpStatus.OK)
  public EntityModel<ResponseCertificateDto> patchUpdateCertificate(
      @PathVariable("id") long id, @RequestBody RequestCertificateDto requestCertificateDto) {
    return certificateLinkCreator.getCertificateWithLinks(
        certificateService.patchUpdateCertificate(id, requestCertificateDto));
  }
