...
public class SqlQuery {
  ...
  // Certificates
  public static final String GET_CERTIFICATE_ID_BY_NAME =
      "SELECT c.id FROM GiftCertificate c WHERE c.name = :name";
  ...
  public static final String FIND_MOST_USED_TAG_ID =
      "SELECT tag_id FROM gift_tag WHERE gift_id in\n"
          + "    (SELECT get_ddi.* "
          + "        FROM user_order, "
