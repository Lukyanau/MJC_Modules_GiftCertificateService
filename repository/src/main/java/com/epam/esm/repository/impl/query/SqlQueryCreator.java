...
import static com.epam.esm.utils.Constant.NAME;
...
public class SqlQueryCreator {
    ...
    public static String createQueryFromCertificateSearchParameters(Map<String, String> searchParams) {
    ...
    public static String createQueryForSearchCertificatesByTags(List<String> tagNames) {
        StringBuilder preparedQuery = new StringBuilder("SELECT * from gift_certificate WHERE id in " +
