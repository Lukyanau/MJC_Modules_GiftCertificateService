...
public interface CertificateService {
  ...
  List<ResponseCertificateDto> getCertificatesByTags(
      Map<String, String> tags, Integer page, Integer size);
  ...
  ResponseCertificateDto patchUpdateCertificate(
      long id, RequestCertificateDto requestCertificateDto);
