...
public class UserServiceTest {
  ...
  void getUsersCorrectDataShouldReturnListOfUsers() {
    ...
    when(userRepository.getAll(Collections.emptyMap(), 1, 1))
        .thenReturn(Optional.of(List.of(user1, user2, user3)));
  ...
  void makeOrderShouldReturnCorrectUser() {
    ...
    List<Order> userOrders =
        List.of(
            new Order(11L, "11userName", "dsa", BigDecimal.valueOf(1000), LocalDateTime.now()),
            new Order(12L, "12userName", "dsa", BigDecimal.valueOf(1500), LocalDateTime.now()),
            new Order(13L, "13userName", "dsa", BigDecimal.valueOf(2000), LocalDateTime.now()));
    List<OrderDto> userOrdersDto =
        List.of(
            new OrderDto(
                11L,
                "11userName",
  ...
  void getUserOrderByIdShouldReturnCorrectOrder() {
    List<Order> userOrders =
        List.of(
            new Order(11L, 11L, "11userName", "dsa", BigDecimal.valueOf(1000), LocalDateTime.now()),
            new Order(12L, 12L, "12userName", "dsa", BigDecimal.valueOf(1500), LocalDateTime.now()),
            new Order(
                13L, 13L, "13userName", "dsa", BigDecimal.valueOf(2000), LocalDateTime.now()));
    OrderDto newOrder =
        new OrderDto(
            11L,
            "11userName",
